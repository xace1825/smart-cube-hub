const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/puzzle-geometry-D_Xjy1L8.js","assets/chunk-O6HEZXGY-sfp9Seqn.js"])))=>i.map(i=>d[i]);
import"./chunk-O6HEZXGY-sfp9Seqn.js";import{d as e,n as t,t as n}from"./chunk-FLK6AZKB-DPaS-Ovq.js";import{t as r}from"./preload-helper-D02TMr53.js";import{t as i}from"./chunk-ROB5TROI-DUQ7rIvP.js";var a=null;async function o(){return a??=s()}async function s(){return i(await n.kpuzzle(),`SubgroupSizes 24 21 18 15 12 9 6
...
Alg F D F' D L2 F R' F' D' B2 U'`)}async function c(){let{getPuzzleGeometryByName:t,ExperimentalPGNotation:n}=await r(async()=>{let{getPuzzleGeometryByName:e,ExperimentalPGNotation:t}=await import(`./puzzle-geometry-D_Xjy1L8.js`);return{getPuzzleGeometryByName:e,ExperimentalPGNotation:t}},__vite__mapDeps([0,1])),i=t(`megaminx`,{allMoves:!0,addRotations:!0}),a=new e(i.getKPuzzleDefinition(!0),{experimentalPGNotation:new n(i,i.getOrbitsDef(!0))});return a.definition.name=`megaminx`,a}var l=null;async function u(){return l??=c()}var d=null;async function f(){return d??=p()}async function p(){return i(await u(),`SubgroupSizes 12 5 60 58 60 56 54 57 52 50 54 48 46 51 44 42 48 40 45 38 36 42 34 32 39 30 36 28 26 33 24 30 22 20 27 18 24 16 14 21 12 18 10 15 8 6 2 12 9 3
...
Alg U BR2' U R' U2' L U2 R U' BR2 U' L'`)}var m=null;async function h(){return m??=_()}async function g(){return{ordering:(await h()).ordering.slice(2)}}async function _(){return i(await t.pyraminx.kpuzzle(),`SubgroupSizes 12 9 12 3 10 3 8 6 2 3 3 3 3
...
Alg u
Alg u'`)}async function v(){let{getPuzzleGeometryByName:t,ExperimentalPGNotation:n}=await r(async()=>{let{getPuzzleGeometryByName:e,ExperimentalPGNotation:t}=await import(`./puzzle-geometry-D_Xjy1L8.js`);return{getPuzzleGeometryByName:e,ExperimentalPGNotation:t}},__vite__mapDeps([0,1])),i=t(`skewb`,{allMoves:!0,addRotations:!0});return new e(i.getKPuzzleDefinition(!0),{experimentalPGNotation:new n(i,i.getOrbitsDef(!0))})}var y=null;async function b(){return y??=v()}var x=null;async function S(){return x??=w()}async function C(){return{ordering:(await S()).ordering.slice(1)}}async function w(){return i(await b(),`SubgroupSizes 24 6 5 12 9 3 4 9 3 3
