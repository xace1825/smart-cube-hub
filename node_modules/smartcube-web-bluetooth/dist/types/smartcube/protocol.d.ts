...
interface SmartCubeProtocol {
    ...
    connect(device: BluetoothDevice, macProvider?: MacAddressProvider, context?: AttachmentContext): Promise<SmartCubeConnection>;
}
declare function registerProtocol(protocol: SmartCubeProtocol): void;
declare function getRegisteredProtocols(): SmartCubeProtocol[];
